...
class TestElementLayout:
    ...
    def test_position_header_elements_title_only(self, calculator: PositionCalculator):
        ...
        expected_y = calculator.margins["top"] + 20  # From element_layout.py implementation
        ...
        expected_x = calculator.margins["left"] + (calculator.max_content_width - title_width) / 2
        assert positioned_title.position[0] == pytest.approx(expected_x)

    def test_position_header_elements_title_and_subtitle(self, calculator: PositionCalculator):
        ...
        subtitle_y = title_y + positioned_title.size[1] + 10  # 10 is spacing from implementation
    ...
    def test_position_header_elements_subtitle_only(self, calculator: PositionCalculator):
        ...
        expected_y = calculator.margins["top"] + 30  # From element_layout.py implementation
    ...
    def test_position_footer_element_default_alignment(self, calculator: PositionCalculator):
        ...
        positioned_footer = next(e for e in slide.elements if e.element_type == ElementType.FOOTER)
    ...
    def test_position_footer_element_with_alignments(self, calculator: PositionCalculator):
