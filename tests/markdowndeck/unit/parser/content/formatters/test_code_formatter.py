...
class TestCodeFormatter:
    ...
    def test_process_code_block_with_directives(self, formatter: CodeFormatter, md_parser: MarkdownIt):
    ...
    def test_process_code_block_with_section_directives(self, formatter: CodeFormatter, md_parser: MarkdownIt):
        ...
        element, _ = formatter.process(tokens, 0, section_directives, element_directives)
    ...
    def test_process_code_block_with_enhanced_css_directives(self, formatter: CodeFormatter, md_parser: MarkdownIt):
...
class TestImageFormatter:
    ...
    def test_can_handle_paragraph_with_image(self, formatter: ImageFormatter, md_parser: MarkdownIt):
        """Test handling of paragraphs containing images."""
        tokens = md_parser.parse("![alt](url.jpg)")
        assert formatter.can_handle(tokens[0], tokens)

    def test_process_image_only_paragraph_with_directives(self, formatter: ImageFormatter, md_parser: MarkdownIt):
    ...
    def test_process_paragraph_with_mixed_content(self, formatter: ImageFormatter, md_parser: MarkdownIt):
    ...
    def test_process_image_with_empty_alt_text(self, formatter: ImageFormatter, md_parser: MarkdownIt):
    ...
    def test_process_image_no_url(self, formatter: ImageFormatter, md_parser: MarkdownIt):
    ...
    def test_process_image_with_responsive_directives(self, formatter: ImageFormatter, md_parser: MarkdownIt):
...
class TestListFormatter:
    ...
    def test_process_bullet_list_with_directives(self, formatter: ListFormatter, md_parser: MarkdownIt):
    ...
    def test_process_ordered_list_with_directives(self, formatter: ListFormatter, md_parser: MarkdownIt):
    ...
    def test_process_nested_list_with_directives(self, formatter: ListFormatter, md_parser: MarkdownIt):
...
* Level 1 Item 2
  ...
  2. Another nested ordered item"""
    ...
    def test_process_list_with_complex_content(self, formatter: ListFormatter, md_parser: MarkdownIt):
...
* Item with ~~strikethrough~~ text"""
        ...
        code_formats = [f for f in item1.formatting if f.format_type == TextFormatType.CODE]
        bold_formats = [f for f in item1.formatting if f.format_type == TextFormatType.BOLD]
        assert len(code_formats) == 1
        assert len(bold_formats) == 1

        item2 = element.items[1]
        link_formats = [f for f in item2.formatting if f.format_type == TextFormatType.LINK]
        assert len(link_formats) == 1
        assert link_formats[0].value == "http://example.com"

        item3 = element.items[2]
        strike_formats = [f for f in item3.formatting if f.format_type == TextFormatType.STRIKETHROUGH]
        assert len(strike_formats) == 1

    def test_process_list_with_section_and_element_directives(self, formatter: ListFormatter, md_parser: MarkdownIt):
...
class TestTableFormatter:
    ...
    def test_process_table_with_directives(self, formatter: TableFormatter, md_parser: MarkdownIt):
...
| Bob | 30 | LA |"""
    ...
    def test_process_table_with_formatting_in_cells(self, formatter: TableFormatter, md_parser: MarkdownIt):
...
| Bob | 30 | `B002` |"""
    ...
    def test_process_table_with_empty_cells(self, formatter: TableFormatter, md_parser: MarkdownIt):
...
|  | Bob | 30 |"""
    ...
    def test_process_table_no_body_rows(self, formatter: TableFormatter, md_parser: MarkdownIt):
...
|---------|---------|"""
    ...
    def test_process_table_with_advanced_styling_directives(self, formatter: TableFormatter, md_parser: MarkdownIt):
...
| Gadget | $20 |"""
    ...
    def test_process_table_with_cell_specific_directives(self, formatter: TableFormatter, md_parser: MarkdownIt):
...
class TestFormatterIntegration:
    ...
    def test_formatter_precedence_image_vs_text(self, factory: ElementFactory, md_parser: MarkdownIt):
    ...
    def test_complex_content_with_multiple_formatters(self, factory: ElementFactory, md_parser: MarkdownIt):
    ...
    def test_directive_merging_consistency_across_formatters(self, factory: ElementFactory, md_parser: MarkdownIt):
