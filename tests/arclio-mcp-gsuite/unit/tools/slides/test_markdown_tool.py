...
import pytest
from arclio_mcp_gsuite.tools.slides import create_presentation_from_markdown
...
class TestCreatePresentationFromMarkdown:
    ...
    def mock_slides_service(self):
        ...
        with patch("arclio_mcp_gsuite.tools.slides.SlidesService") as mock_service_class:
