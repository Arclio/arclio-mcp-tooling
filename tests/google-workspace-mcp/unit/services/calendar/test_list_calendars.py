...
class TestCalendarListCalendars:
    ...
    def test_list_calendars_error(self, mock_calendar_service):
        ...
        mock_calendar_service.service.calendarList.return_value.list.return_value.execute.side_effect = http_error
        ...
        mock_calendar_service.handle_api_error.assert_called_once_with("list_calendars", http_error)
