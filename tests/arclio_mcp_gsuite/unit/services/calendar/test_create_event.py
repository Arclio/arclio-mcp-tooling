...
class TestCalendarCreateEvent:
    ...
    def test_create_event_success(self, mock_calendar_service):
        ...
        mock_calendar_service.service.events.return_value.insert.return_value.execute = (
            mock_execute
        )
        ...
        call_args = mock_calendar_service.service.events.return_value.insert.call_args
    ...
    def test_create_event_error(self, mock_calendar_service):
        ...
        mock_calendar_service.service.events.return_value.insert.return_value.execute.side_effect = (
            http_error
        )
