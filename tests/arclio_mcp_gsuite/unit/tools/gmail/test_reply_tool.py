...
import pytest
from arclio_mcp_gsuite.tools.gmail import reply_gmail_email
...
class TestReplyGmailEmail:
    ...
    async def test_reply_missing_args(self):
        ...
        with pytest.raises(
            ValueError, match="Original message ID and reply body are required"
        ):
    ...
    @patch("arclio_mcp_gsuite.tools.gmail.GmailService")
